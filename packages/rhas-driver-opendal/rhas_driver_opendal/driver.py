...
class Opendal(Driver):
    ...
    @classmethod
    def client(cls) -> str:
        return "rhas_driver_opendal.client.OpendalClient"
...
class FlasherInterface(metaclass=ABCMeta):
    ...
    @classmethod
    def client(cls) -> str:
        return "rhas_driver_opendal.client.FlasherClient"
...
class StorageMuxInterface(metaclass=ABCMeta):
    ...
    @classmethod
    def client(cls) -> str:
        return "rhas_driver_opendal.client.StorageMuxClient"
...
class StorageMuxFlasherInterface(StorageMuxInterface):
    @classmethod
    def client(cls) -> str:
        return "rhas_driver_opendal.client.StorageMuxFlasherClient"
